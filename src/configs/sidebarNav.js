...
export const work_description = [
    ...
    },
    {
        ...
        workdetail:['지속적인 고객 유치를 위한 고객서비스', '상품 재고 관리 및 로테이션을 위한 행사 계획','매입처 확보 및 구매','매장 월말 정산']
    },
    {
        title:'Zara',
        ...
        workdetail:['고객 컴플레인 핸들링','상품 디스플레이', '상품별 판매 매출 분석', '상품별 재고 관리 및 반품, 이관·출고 관리']
    },
]
...
export const project_description = [
    ...
    },
    {
        ...
        fuc:[
            ...
            {
            title:'scrollReveal.js 라이브러리를 사용하여 스크롤에 따라 인터렉션 구현', 
            des:''
            },
            {
            title:'사용자가 보고있는 영역에 대한 Nav link 활성화 및 클릭시 해당 섹션으로 이동 구현', 
            des:''
            },    
        ],
        url:{
